...
export default function Menu() {
  ...
  function Page({ children }: PropsWithChildren<{}>) {
    return (
      <>
        <div className={`fixedPage full ${styles.page}`} onClick={() => isDrawerOpen && setDrawerOpen(false)}>
          {children}
        </div>
  ...
  return (
    <>
      ...
      <Trigger style={{ right: 0 }} open={isDrawerOpen} onClick={() => setDrawerOpen(!isDrawerOpen)} />
